...
var introCanvas = document.querySelector("#js-canvas-title"),
    ...
    createIntro = function() {
        ...
        s.setClearColor("#4DD0E1", 0), s.setSize(window.innerWidth, window.innerHeight), introCanvas.appendChild(s.domElement);
        ...
        for (var i = Math.ceil(24), o = Math.ceil(15), h = Math.ceil(60), c = new THREE.TorusBufferGeometry(i, o, h, 120), u = 0; u < 200; u++) {
            new t(c, Math.ceil(2e3)).create()
        }
        for (var l = new THREE.BoxBufferGeometry(80, 80, 80), m = 0; m < 200; m++) {
            new t(l, Math.ceil(e / 3)).create()
        }
        a.add(d);
        var w = new THREE.FontLoader,
            M = new THREE.Mesh;
        w.load("js/typeface.json", function(e) {
            var t = {
                    font: e,
                    size: Math.ceil(132),
                    height: 120,
                ...
                i = new THREE.TextGeometry("addrezz.ai\ncoming soon...", t);
            M.geometry = i, M.material = n, M.geometry.computeBoundingBox(), M.geometry.boundingBox.getCenter(M.position).multiplyScalar(-1), a.add(M)
        });
        var v = 0,
            E = 0,
            f = {
                ...
                coordinates: function(e, t) {
                    v = 5 * (e - f.windowHalfX), E = 5 * (t - f.windowHalfY)
                },
